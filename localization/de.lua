    ...
    descriptions = {
        alt_texture = {
            ...
            alt_tex_quints_other_jokers = {
                name = "Andere Jokers",
                j_joker = {name = "Futaro"},
                j_diet_cola = {name = "Matcha-Limonade"},
            },

            alt_tex_quints_spectrals = {
                name = "Die Seele",
                c_soul = {
                    name = "Die Seele der Nakano",
                },
            },
        },
        ...
        texture_packs = {
            texpack_quints_lumine_cards = {
                ...
                text = {
                    "Überarbeitet legendäre und andere Joker",
                    "zu Charakteren aus",
                    "Go-Toubun no Hanayome!",
                    "{C:inactive,s:0.8}Art von Lumine und Turpix.{}",
                },
            },
        },
    },
